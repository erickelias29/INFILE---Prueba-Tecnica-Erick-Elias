...
export default () => {
  ...
  const conseguirArticulos = async () => {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NjI5ZDAzMDM4MTk5OTIwOGVhNWE0ZGYiLCJ1c2VybmFtZSI6ImthcHNpb24iLCJpYXQiOjE3MTQwMjUyMDksImV4cCI6MTcxNDAyODgwOX0.yRmvhv1w9TPYHRW2dMloe92gqrqUv63m_s3w1m--UHg";
      ...
      <Content>
        ...
        <CardSlider ref={setSliderRef} {...sliderSettings}>
          ...
          {articulos.map((articulo, index) => (
            <Card key={index}>
              <CardImage imageSrc={articulo.imageSrc} />
              <TextInfo>
                <TitleReviewContainer>
                  <Title>{articulo.title}</Title>
                  <RatingsInfo>
                    <StarIcon />
                    <Rating>{articulo.rating}</Rating>
                  </RatingsInfo>
                </TitleReviewContainer>
                <SecondaryInfoContainer>
                  <IconWithText>
                    ...
                    <Text>{articulo.locationText}</Text>
                  </IconWithText>
                  <IconWithText>
                    <IconContainer>
                      <PriceIcon />
                    </IconContainer>
                    <Text>{articulo.pricingText}</Text>
                  </IconWithText>
                </SecondaryInfoContainer>
                <Description>{articulo.description}</Description>
              </TextInfo>
